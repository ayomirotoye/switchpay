        ...
        <div class="table-responsive">
            <table class="table table-striped userProfiles">
                ...
                <tr>
                    ...
                    <td><button class="btn btn-primary" data-toggle="modal" data-target="#editUser"
...
<div id="editUser" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="addNewUserLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <form action="${pageContext.request.contextPath}/edituser" method="post">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-default closeModal" data-dismiss="modal">Close</button>
                    <button class="btn btn-primary adduser" type="submit">Edit User</button>
                </div>
            </form>
        </div>
    </div>
