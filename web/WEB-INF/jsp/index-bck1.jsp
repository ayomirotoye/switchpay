...
<html>
    <head>
        ...
        <link rel="icon" href="<spring:url value="/resources/imgs/ospoly_logo.png"/>" type="image/png"/>
                ...
                <div class="row">
                    <div class="col-12">
                        <nav class="navbar navbar-expand-lg py-0">
                            <img src="<c:url value="/resources/imgs/ospoly_logo.png"/>" alt="Ospoly Logo" height=50>
                            <a class="navbar-brand" href="welcome">OSpoly</a>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav ml-auto">
                                    <li class="nav-item">
                                        ...
                                        <a href="/payBills" class="btn btn-sm btn-secondary" data-toggle="modal" data-target="#loginModal">Pay Bills</a>
                                        <a href="/airtimePurchase" class="btn btn-sm btn-secondary" data-toggle="modal" data-target="#loginModal">Purchase Airtime</a>
                                        <a href="/fundTransfer" class="btn btn-sm btn-secondary" data-toggle="modal" data-target="#loginModal">Transfer Funds</a>
                                    </li>           
                                </ul>
                            </div>
                        </nav>
                    ...
                    <div class="modal-body">
                        <form name='loginForm' action="<c:url value='/j_spring_security_check' />" method='POST'>
                            ...
                            <div class="form-group m-0 text-center">
                                <button type="submit" name="submit" class="btn btn-secondary btn-block mb-3"><i class="fa fa-unlock" aria-hidden="true"></i> Login</button>
                ...
                <div class="row">
                    <div class="col-12 d-flex">
                        <div class="bg-dark py-3 px-2" style="width: 300px; min-width:300px; height: 550px; border-radius: 20px;margin-bottom: -120px">
                            ...
                            <div class="bg-white w-100" style="border-radius: 20px; height: calc(100% - 20px); background-image: url(<spring:url value="/resources/imgs/ospoly_mobile.jpg"/>); background-size: 100%"></div>
                        </div>
                        <div class="w-auto pl-5 p-3 align-self-center">
                            <h2 class="display-3 text-white text-shadow font2">enjoy <span class="text-secondary">OSpoly </span><br>online</h2>
                            <div class="border border-primary mb-3 w-25"></div>
                            <a href="/payBills" class="btn btn-lg btn-secondary" data-toggle="modal" data-target="#loginModal">Login</a>
